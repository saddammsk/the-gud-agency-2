  ...
  return (
    <div className="">
      <div className="relative text-start group flex flex-col transition-transform origin-top-left hover:scale-[1.06]">
        ...
        <div className="bg-black/[0.69] card-body !text-start rounded-[20px] flex flex-col justify-end 3xl:px-6 md:px-4 px-3.5 xl:py-10 md:py-7 py-5 absolute left-0 top-0 w-full h-full opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500">
