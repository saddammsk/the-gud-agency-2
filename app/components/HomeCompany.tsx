                    ...
                    <div className="max-w-[1760px] px-5 mx-auto">
                         <div className="w-fit mx-auto 3xl:mb-14 md:mb-3 mb-5">
                              ...
                              <div className="md:text-end text-center">
                                   <img src="images/yellow-line.svg" className="inline-block md:w-auto w-[156px] mx-auto" alt="" />
                              </div>
                         </div>
                         <p className="3xl:text-[30px] md:text-xl text-sm  font-normal text-center 3xl:mb-[120px] md:mb-[70px] mb-[50px] text-white">Real words from real clients.  <span className="text-tertiary block 3xl:text-[30px] text-xl font-annie">See why brands trust us to bring the gud.</span></p>
