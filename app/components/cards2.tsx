...
export default function Card2({ image, title, subtitle, description, href }: CardProps) {
     return (
          <div className="">
               <div className="relative text-start group overflow-hidden rounded-[20px] flex flex-col ">
                    <div>
                         <img
                              src={image}
                              alt={title}
                              className="rounded-[20px] group-hover:scale-[1.10] transition-transform origin-top-left  w-full h-full"
                         />
                    </div>
